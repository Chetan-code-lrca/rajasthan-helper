...
mkdir "C:\Users\cheta\rajasthan-helper\.github" 2>nul

REM Create copilot-instructions.md using Python one-liner
python -c "
import os
...
with open(os.path.join(github_dir, 'copilot-instructions.md'), 'w', encoding='utf-8') as f:
    f.write(content)
echo ✓ Successfully created .github directory and copilot-instructions.md
"

...
const content = `# Copilot Instructions - [PROJECT_NAME] CLI
...
try {
  ...
  if (fs.existsSync(filePath)) {
    ...
    console.log('✓ File successfully created at: C:\\Users\\cheta\\rajasthan-helper\\.github\\copilot-instructions.md');
    console.log('  File size: ' + stats.size + ' bytes');
    console.log('');
    console.log('✓ TASK COMPLETED SUCCESSFULLY');
  } else {
    console.log('✗ Error: File not found after creation');
    process.exit(1);
  }
} catch (err) {
